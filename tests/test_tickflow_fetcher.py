...
class TestTickFlowFetcher(unittest.TestCase):
    def test_get_realtime_quote_maps_single_stock(self):
        ...
        self.assertAlmostEqual(quote.price, 1800.0)
        self.assertAlmostEqual(quote.change_pct, 1.12)
        self.assertAlmostEqual(quote.change_amount, 20.0)
        self.assertAlmostEqual(quote.amplitude, 1.8)
        self.assertEqual(fetcher._client.quotes.calls[0]["symbols"], ["600519.SH"])
