...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TUSHARE_API_URL": {
        ...
        "description": "Optional override for the Tushare-compatible HTTP endpoint. Leave empty to use the official http://api.tushare.pro.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "default_value": None,
        "options": [],
        "validation": {"url": True, "allow_empty": True},
        "display_order": 11,
    },
    "TICKFLOW_API_KEY": {
